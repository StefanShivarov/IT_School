...
public class doc7_ex3 {
	...
	private void initialize() {
		...
		addBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(numbersList.contains(number)) {
					JOptionPane.showMessageDialog(null, "This number is already in the list. Pick another number!", "Error!", JOptionPane.ERROR_MESSAGE);
				}else {
					numbersList.add(number);
					displayList(numbersList, textArea);
				}
				textField.setText("");
			}
		});
		...
		shuffleBtn.setFont(new Font("Tahoma", Font.PLAIN, 14));
		...
		reverseBtn.setFont(new Font("Tahoma", Font.PLAIN, 14));
